...
export default function ProductForm({
  ...
  const renderCheckIcon = (fieldValue) => {
    return fieldValue ? <BiCheck className="text-green-500" /> : null;
  };
        ...
        <div className="flex max-lg:flex-wrap gap-4">
          <div className="space-y-4 w-full p-4 bg-primary rounded-lg">
            ...
            <div className="space-y-4">
              <div>
                <label className="flex items-center gap-2 font-medium">Brand Name {renderCheckIcon(formData?.brandName)}</label>
