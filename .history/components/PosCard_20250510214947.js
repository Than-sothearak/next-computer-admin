  ...
  return (
    <>
      <div className="w-full p-4 bg-primary mt-4 rounded-lg">
        <button className="flex items-center  gap-2 text-primary z-50 sm:hidden p-2 rounded-l-xl bg-red-500 fixed w-22 right-0 ">
          <MdMenuOpen />
          Order list
        </button>
      ...
      <div className="bg-red-300 w-1/2 max-lg:absolute max-lg:w-full top-0 right-0 left-0 p-4 max-lg:max-h-0 bg-primary mt-4 rounded-lg h-screen">
