  ...
  return (
    <div className="">
      ...
      >
       ...
       {files.length > 0 && (
           <div className="grid grid-cols-4 gap-4 border-dashed border-slate-600 mt-2 rounded-md border-2 p-4 w-full">
           {files.map((fileData, index) => (
             <div
               key={index}
               className="rounded-md md:w-44 bg-slate-500 relative group"
             >
