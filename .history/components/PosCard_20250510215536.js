  ...
  return (
    <>
      <div className="w-full p-4 bg-primary mt-4 rounded-lg">
        <button onClick={() => setIsOpen(!isOpen)} className={`flex items-center  gap-2 text-primary z-50 sm:hidden p-2 rounded-l-xl bg-red-500 fixed w-22  ${isOpen ? 'right-0' : 'right-0'}`}>
          <MdMenuOpen />
          Order list
        </button>
