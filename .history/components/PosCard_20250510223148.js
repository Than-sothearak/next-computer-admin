...
const PosCard = ({ products }) => {
  ...
  return (
    <>
      ...
      <div className={`bg-black mt-4 h-screen p-4
         left-0 z-40 transform rounded-lg top-4  max-sm:fixed transition-transform w-1/3 max-md:w-1/2 duration-700 ease-in-out
        ${
