  ...
  return (
    <>
      ...
      <div
        ...
        } absolute bg-slate-500 p-4 flex gap-2 justify-items-center items-center rounded-md transition-opacity duration-200 ease-out z-10 right-20 top-2 max-md:right-0`}
      >
        <Link
          href={link}
