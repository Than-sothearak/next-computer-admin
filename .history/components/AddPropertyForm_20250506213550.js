            ...
            >
              ...
              <div className="w-full mt-2">
                <div className="flex gap-2 justify-start items-center">
                  <button
                    type="button"
                    className={`${part.values[part.values.length - 1] === "" ? 'cursor-not-allowed': ''} bg-blue-500 text-secondarytext px-3 py-1 rounded h-8 w-8 hover:bg-blue-700`}
                    onClick={() => addValue(partIndex)}
                    disabled={part.values[part.values.length - 1] === ""}
                  >
                    
                  </button>
                  <label className="w-full block font-medium">Z
