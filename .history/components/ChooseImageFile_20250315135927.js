  ...
  return (
    <div className="">
      ...
      <div
        className={`${
          files.length <= 0 ? "" : ""
        }  flex h-full items-center justify-start gap-4`}
      >
        <div className="w-full flex justify-center items-center gap-8 flex-col border-dashed border-slate-600 mt-2 rounded-md border-2 p-8">
        ...
        {/* {files.length <= 0 && <h1 className="text-slate-300 text-md">Upload image</h1>} */}
          ...
          <div className="flex gap-4 mt-4 mb-2 h-full w-full border p-4">
