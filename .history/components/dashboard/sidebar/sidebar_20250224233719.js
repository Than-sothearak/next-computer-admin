...
export const Sidebar = () => {
  ...
  return (
    ...
    {/* Mobile side */}
      <div className="bg-primary lg:hidden ml-1 mt-4 z-50">
      ...
      <div 
        className={`bg-primary p-4 w-72 fixed top-0 left-0 z-50 transform transition-transform  duration-700 ease-in-out
