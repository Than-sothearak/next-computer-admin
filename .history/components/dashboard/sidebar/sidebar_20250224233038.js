...
export const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center bottom-0 lg:hidden">
    ...
    {/* Mobile side */}
      ...
      <div 
        className={`bg-slate-800 p-4 w-64 fixed top-0 left-0 z-50 transform transition-transform duration-700 ease-in-out
