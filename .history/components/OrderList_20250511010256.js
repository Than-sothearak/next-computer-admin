...
const OrderList = ({ isOpen, customerID, handleGenerate, cartItems }) => {
  return (
    <div
      ...
      <div className="flex flex-col gap-2 mt-4 border p-4 rounded-md">
        ...
        <div className="flex max-md:flex-wrap gap-2 items-center text-sm">
          ...
          <button
            ...
            className="w-full bg-blue-500 p-1 w-full rounded-md text-primary"
          >
            Auto generate ID
          </button>
        </div>
      ...
      <table className="w-full mt-2">
        ...
        <tbody>
          <tr className="border-b ">
            <td className="p-2">
              <p className="text-xs">Product Id CUST-20250510-5AU93E</p>
              <h1 className="font-bold truncate w-[100px]">
                Iphone 13 ewwwwwwwwww
              </h1>
            </td>
