  ...
  return (
    <div className="">
      ...
      <div
        className={`${
          files.length <= 0 ? "" : ""
        } border-2  flex  items-center justify-center gap-4 border-dashed border-slate-600 mt-2 rounded-md py-10`}
      >
        <div className="flex justify-center items-center gap-8 flex-col border-dashed border-slate-600 mt-2 rounded-md border p-2">
