    ...
    <>
      <div className="w-full p-4 bg-primary mt-4 rounded-lg">
        ...
        <div className="flex flex-wrap gap-2 justify-between items-center mb-4">
          ...
          <button title="Gird view"><IoGrid /></button>
          <button title="List view"><IoListSharp size={22}/></button>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2">
          {products?.map((product, index) => (
            <div
              key={index}
              className="bg-white rounded-lg shadow-md p-2 flex justify-between items-center border"
            >
              <div className="flex  items-center gap-2 justify-between w-full">
               ...
               <div className="flex items-center justify-between gap-4 border w-full">
               <h2 className="text-sm font-semibold truncate w-full max-w-[100px]">
                  {product.productName}
                </h2>
