...
export default function ChooseImageFile() {
  ...
  return (
    <div className="w-auto">
      ...
      <div className={`${files.length <= 0 ? 'h-52' : ''} border-2  flex flex-col items-center justify-center gap-4 border-dashed border-slate-600 p-4 mt-2 rounded-md`}>
      <div className="flex flex-col justify-center items-center items-center">
        <BiUpload size={28}/>
         <div>
         <label
