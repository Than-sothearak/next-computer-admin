              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    type="button"
                    className={`"mt-3 bg-blue-600 text-white text-xs py-1 px-2 rounded  ${
                      availableStock <= 0
              ...
              return (
                ...
                >
                  ...
                  <button
                   disabled={availableStock <= 0}
                    onClick={() => handleAddToCart(product)}
                    className={`mt-3 bg-blue-600 text-white text-xs py-1 px-2 rounded hover:bg-blue-800 ${availableStock <=0 ? 'bg-secondary cursor-not-allowed' : ''}`}
                  >
                    Add
                  </button>
                </div>
