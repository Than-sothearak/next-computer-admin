  ...
  return (
    <>
      ...
      <div
        ...
        } absolute bg-slate-500 p-2 flex gap-2 justify-items-center items-center rounded-md transition-opacity duration-200 ease-out z-10 right-10 top-9 max-md:right-0`}
      >
        <Link
          href={link}
          className="bg-blue-600 px-2 py-1 rounded-md hover:bg-blue-900 text-sm"
        >
          Edit
        </Link>
        <button
          onClick={() => setShowConfirmation(true)}
          className="bg-red-800 px-2 py-1 rounded-md hover:bg-red-900 text-sm"
        >
          Delete
