          ...
          formData.properties.map((part, partIndex) => (
            ...
            >
              ...
              <div className="w-full mt-2">
                ...
                <button
                    type="button"
                    className={`${part.values[part.values.length - 1] === "" ? 'cursor-not-allowed text-slate-400': 'hover:bg-blue-700 hover:text-primary text-blue-600'} px-3 py-1 rounded h-8 w-full mt-4 `}
