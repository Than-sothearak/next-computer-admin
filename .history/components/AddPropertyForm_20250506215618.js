...
const AddPropertyForm = ({ formData, setFormData }) => {
  ...
  return (
    <div className="flex flex-col gap-2 mb-4">
      <button
        type="button"
        className={`${checkIsPropertyEmpty ? 'cursor-not-allowed' : ''} bg-blue-600 w-36 p-2 text-secondarytext rounded-md flex items-center gap-2 text-base hover:underline hover:bg-blue-500`}
        onClick={addPart}
