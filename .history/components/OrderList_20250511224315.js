        ...
        <tbody>
          ...
          <tr className="">
            ...
            <td className="text-end">
              <button
                disabled={inputCustomerID === "" && inputCustomerPhone === ""}
                onClick={handlePayment}
                className={`${inputCustomerID === "" || inputCustomerPhone === "" ? 'bg-secondary cursor-not-allowed' : ''} py-2 px-4 bg-blue-500 rounded-md text-primary`}
              >
                Payment
              </button>
            </td>
