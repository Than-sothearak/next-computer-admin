...
const PosCard = ({ products }) => {
 ...
 const handleAddToCart = (product) => {
  ...
  if (product.stock <= 0) return; // Prevent adding if stock is 0
             ...
             return (
              ...
              >
                ...
                <button
                  ...
                  type="button"
                  className={`"mt-3 bg-blue-600 text-white text-xs py-1 px-2 rounded  ${product.stock <=0 ? 'bg-secondary cursor-not-allowed' :'hover:bg-blue-800'}`}
                >
                  Add to Cart
                </button>
              </div>
