                ...
                {formData?.imageUrls && formData.imageUrls.length > 0 ? (
                  formData?.imageUrls.map((image, index) => (
                    <div
                      className={`${
                        index === 0 ? "col-span-2" : ""
                      } rounded-md w-full min-h-32 bg-secondary relative group`}
                      key={index}
                    >
                      ...
                      <img
                        ...
                        alt={`Image ${index}`}
                        className="rounded-md object-cover h-full w-full transition-opacity duration-300 group-hover:opacity-15"
                        src={`${image}`}
                      />
                      <button
                      type="button"
