...
export default function ChooseImageFile() {
  ...
  return (
    <div className="w-auto">
      ...
      <div className={`${files.length <= 0 ? 'h-52' : ''} border-2  flex flex-col items-center justify-center gap-4p-4 mt-2 rounded-md`}>
      <div className="flex flex-col items-center  border-dashed border-slate-600 ">
          <label
