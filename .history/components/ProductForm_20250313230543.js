            ...
            <div className=" bg-primary p-4 w-full flex  flex-col  gap-4 rounded-lg">
              ...
              >
                ...
                {parentCategory?.map((category) => (
                  <option key={category._id} value={formData?.parentCategory ? formData?.parentCategory._id :category._id}>
                   {formData?.parentCategory ?  formData?.parentCategory.category : category.category } 
                  </option>
                ))}
              </select>
              <p className="text-xs text-slate-500">
