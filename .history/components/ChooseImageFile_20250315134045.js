  ...
  return (
    <div className="w-auto">
      ...
      <div
        className={`${
          files.length <= 0 ? "h-52" : ""
        } border-2  flex flex-col items-center justify-center gap-4 border-dashed border-slate-600 p-4 mt-2 rounded-md`}
      >
        <div className="flex flex-col justify-between items-center">
          ...
          <div>
            <label
              ...
              className="cursor-pointer bg-blue-600 text-primarytext  rounded-lg hover:bg-indigo-700 transition duration-200"
            >
              Choose Image
            </label>
            <input
