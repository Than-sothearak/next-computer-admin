...
export default function ChooseImageFile() {
  ...
  {files.length > 0 && (
          <div className="flex gap-4 mt-4 mb-2 h-full w-full border">
            ...
            >
              {fileData.file.type.startsWith("image/") ? (
                <img
                  ...
                  alt="Preview"
                  className="rounded-md object-cover w-full  transition-opacity duration-300 group-hover:opacity-25"
                />
              ) : (
