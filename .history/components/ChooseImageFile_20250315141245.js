  ...
  return (
    <div className="">
      ...
      >
       ...
       {files.length > 0 && (
           <div className="grid lg:grid-cols-4 md:grid-cols-3 max-lg:grid-col-3 grid-cols-2 gap-4 border-dashed border-slate-600 mt-2 rounded-md border-2 p-4 w-full">
