      ...
      <table className="w-full mt-2">
        ...
        <tbody>
          {cartItems?.map((item, index) => (
            ...
            <td className="py-2 text-end">Delete</td>
          </tr>
          ))}
       <tr className="border-b text-sm" >
          ...
          <td></td>
           <td></td>
            <td></td>
             <td className="font-bold text-end">1212121$</td>
       </tr>

           <tr className="border-b" >
            <td className="font-bold py-2  text-end">Total</td>
          <td></td>
           <td></td>
            <td></td>
             <td className="font-bold">1212121$</td>
       </tr>
       <tr className="border">
        ...
        <td></td>
         <td></td>
          <td className="text-end"><button className="p-2 bg-blue-500 rounded-md text-primary ">Payment</button></td>
       </tr>
