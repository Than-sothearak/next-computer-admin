    ...
    <>
      <div className="w-full p-4 bg-primary mt-4 rounded-lg">
        ...
        <div className="flex flex-wrap gap-2 justify-between items-center mb-4">
          ...
          />
          <div className="flex gap-2 items-center color-red-500">
          <button title="Gird view" onClick={() => setIsGridView(true)}><IoGrid /></button>
          <button title="List view" onClick={() => setIsGridView(false)}><IoListSharp size={22}/></button>
          </div>
        </div>
