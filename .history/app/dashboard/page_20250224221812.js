      ...
      <table className="w-full rounded-lg overflow-hidden">
        ...
        <tbody className="text-sm">
          {latestTransactions.map((transaction, index) => (
            ...
            >
              <td className="p-2 flex gap-2 items-center"><img className="object-cover w-11 h-11 rounded-full " src="https://wac-cdn.atlassian.com/dam/jcr:ba03a215-2f45-40f5-8540-b2015223c918/Max-R_Headshot%20(1).jpg?cdnVersion=2574"/>{transaction.name}</td>
              <td className="p-3">
                <span
