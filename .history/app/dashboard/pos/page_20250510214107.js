...
const posPage = async () => {
  ...
  return (
    <div className="flex gap-2 max-sm:flex-col">
      <div className="w-full p-2 rounded-md bg-primary mt-4 rounded-lg">
        <button className="flex items-center  gap-2 text-primary z-50 sm:hidden p-4 bg-red-500 fixed w-22 right-0 "><MdMenuOpen />Order list</button>
