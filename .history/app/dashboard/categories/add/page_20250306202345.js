            ...
            <div className="flex gap-4">
              ...
              <div className="w-full flex flex-col gap-2">
                ...
                <select
                  ...
                  className="w-full p-2 rounded-md bg-secondary border-none border-white text-xs focus:ring-0 focus:outline-none"
                >
                  <option value="" name="parentCategory">
                    Select a parent category
                  </option>
                  <option value="Iwatch" name="parentCategory">
                    Iwatch
                  </option>
                  <option value="Computer" name="parentCategory">
                    Computer
                  </option>
                  <option value="Smartphone" name="parentCategory">
                    Smartphone
                  </option>
                </select>
              </div>
                  ...
                  <div className="w-full flex gap-4 max-md:flex-wrap">
                    ...
                    <div className="w-full">
                      ...
                      <div className="mt-2 flex gap-2">
                        ...
                        <button
                          type="button"
                          className="bg-green-500 text-primarytext px-3 py-1 rounded h-10 w-10"
