      ...
      <table className="w-full rounded-lg overflow-hidden">
        ...
        <tbody className="text-sm">
          {latestTransactions.map((transaction, index) => (
            ...
            >
              <td className="p-3 flex gap-2 items-center"><img className="object-cover w-11 h-11 rounded-full " src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/User_icon_2.svg/1200px-User_icon_2.svg.png"/>{transaction.name}</td>
              <td className="p-3">
                <span
