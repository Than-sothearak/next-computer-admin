      ...
      <table className="w-full rounded-lg overflow-hidden">
        ...
        <tbody className="text-sm">
          {latestTransactions.map((transaction, index) => (
            ...
            >
              <td className="p-3"><img className="w-11 h-11 rounded-full " src="https://resizing.flixster.com/wfq5vXDxDPMl8NAZihcqSXhtVEE=/fit-in/352x330/v2/https://resizing.flixster.com/-XZAfHZM39UwaGJIFWKAE8fS0ak=/v3/t/v9/AllPhotos/235135/235135_v9_ba.jpg"/>{transaction.name}</td>
              <td className="p-3">
                <span
